        ...
        <div class="row">
            <div class="col-12 d-md-none">
                <div class="dashboard__sidebar--hello">
                    ...
                    @else
                        <span style="font-size:16px;">Save your progress, create your account <a href="{{url('/register?ref=' . Request::url())}}" class="url">Register</a></span>
                    @endif
                </div>
            </div>
                ...
                <div class="dashboard__sidebar">
                    ...
                    <div class="block">
                        ...
                        <div class="trending">
                            ...
                            <a href="{{url('community')}}" class="btn">Post a question</a>
                        </div>
                    </div>
                        ...
                        <div class="tasks">
                            <div>
                                <div class="tasks__item">
                                    ...
                                    @else
                                        <a href="{{url('/register?ref=' . Request::url())}}" class="btn bottom">Learn More</a>
                                    @endif
                                </div>
                            </div>
                            <div>
                                ...
                                @foreach($properties as $property)
                                    ...
                                    <div>
                                        <div class="tasks__item">
                                            ...
                                            <span class="tasks__item--price">${{$property->rate}}</span>
